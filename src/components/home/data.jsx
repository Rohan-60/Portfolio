...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title">Rohan K Shine
                <svg
                    width="35"
                    height="35"
                    viewBox="0 0 48 48"
            ...
            <p className="home_description">I am a Full Stack Developer based in India, with a passion for building web applications that solve real-world problems.</p>
